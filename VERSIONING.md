...
- **Validation**: Only works on alpha/beta/rc versions for stage operations
...
2. **Keywords are case-insensitive** - `Alpha Increment` works the same as `alpha increment`
3. **Stage operations only work on pre-release versions** - you can't increment alpha on a stable version
4. **Graduation works from any pre-release stage** - you can graduate directly from alpha, beta, or rc
5. **Version preservation** - semantic bumps (patch/minor/major) preserve your current pre-release stage
